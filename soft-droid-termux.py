...
#-*- coding: utf-8 -*-
#Author      Sani kushwah
#Instagram   @h3max0.tech
#Website    www.techclown.co.in
...
def head():
    ...
    print'''{0}
       ...
       *****    SOFT-DROID   *****
{2}Follow me :{3}
{1}•{3} GitHub : {4}https://github.com/h3max0{3}
{1}•{3} Website: {4}https://techclown.co.in{3}
...
def main(platform, type):
    lhost = raw_input("\nEnter your LHOST\n{0}{1}SOFT-DROID:~/LHOST#{2} ".format(green, bold, end))
    lport = raw_input("\nEnter your LPORT\n{0}{1}SOFT-DROID:~/LPORT#{2} ".format(green, bold, end))
    output = raw_input("\nEnter the name of output file\n{0}{1}SOFT-DROID:~/output#{2} ".format(green, bold, end))
    #Windows
